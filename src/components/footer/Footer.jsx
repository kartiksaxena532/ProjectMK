...
const Footer = () => {
  return (
    ...
    <div className="flex border-2 justify-start border-neutral-300 p-1 w-1/5 rounded-full font-sans">
      ...
      <div className="bg-white text-white rounded-full w-10 h-10 flex justify-center items-center hover:bg-green-500 rotate-90 hover:duration-300 hover:ease-in-out "><MdArrowOutward className="fill-black w-10 h-10 p-2"/></div>
    </div>
