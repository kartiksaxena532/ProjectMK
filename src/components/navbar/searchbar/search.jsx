...
const Search = () => {
  return (
    <div className="flex mr-5 border-2 border-neutral-300 p-1 rounded-full font-sans">
      ...
      <button type ="submit" className="bg-white text-white p-1 rounded-full w-12 h-12 flex justify-center items-center hover:bg-green-500 "><MdArrowOutward className="fill-black w-8 h-8"/></button>
    </div>
  )
}
