  ...
  return (
    <div className="flex flex-col h-[50vh] md:h-[75vh] w-full md:w-[38vw] justify-between font-bold">
      <div className="flex flex-col items-start ">
        <p className="font-regular text-md my-1 tracking-wider font-mons">Our Design Portfolio, we believe in </p>
        <hr className="w-full md:w-[22vw] rounded-full ring-fuchsia-100"></hr>
      </div>
