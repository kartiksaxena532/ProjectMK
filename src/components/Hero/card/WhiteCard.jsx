...
const WhiteCard = () => {
  ...
  return (
    <div>
      ...
      <p className="text-gray-600 font-semibold text-lg -ml-0.2 leading-none tracking-wide mt-4">
        How Latest Technical <br/>Advancedment Are<br/>Changing The World
      </p>
      </div>
      <img src={card} alt="Logo" className=" w-56 h-54" />
      <div className=" absolute ml-24 -mt-6 bg-green-500 w-32 h-10 rounded-full justify-center items-center flex text-black hover:text-white hover:ring-green-300 hover:ring-2 ">Read More</div>
